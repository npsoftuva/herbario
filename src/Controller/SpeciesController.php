...
class SpeciesController extends AppController
{
    ...
    public function add()
    {
        ...
        $genres = $this->Species->Genres->find('list', ['limit' => 200]);
        $collections = $this->Species->Collections->find('list', ['limit' => 200]);
        $this->set(compact('species', 'genres', 'collections'));
        $this->set('_serialize', ['species']);
    }
